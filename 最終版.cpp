...
int main()
{
    ...
    turnPlace[0] = Xs;
    turnPlace[1] = Ys;
    turnPlace[2 * turnTimes + 2] = Xt;
    turnPlace[2 * turnTimes + 3] = Yt;
    ...
    while ( ansK <= turnTimes )
    {
        ...
        {
            if(ansK>=1){
                if((yy[path] - turnPlace[2*ansK+1] == 0 && turnPlace[2*ansK+1] - turnPlace[2*ansK-1] == 0) || ((xx[path] - turnPlace[2*ansK]) / static_cast<float>(yy[path] - turnPlace[2*ansK+1]) ==
                                                                                                               (turnPlace[2*ansK]-turnPlace[2*ansK-2]) / static_cast<float>(turnPlace[2*ansK+1]-turnPlace[2*ansK-1]))){
                    XX = xx[path];
                    YY = yy[path];
                    ansDistance += sqrt(pow((yy[path] - turnPlace[2*ansK+1]), 2) + pow((xx[path] - turnPlace[2*ansK]), 2));
                    turnPlace[2*ansK] = xx[path];
                    turnPlace[2*ansK+1] = yy[path];
                    lowCost = minCost - w ;
